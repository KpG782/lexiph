-- =====================================================
-- INSERT MOCK DATA FOR KEN PATRICK GARCIA
...
DO $$
DECLARE
  v_user_id UUID := 'c887ef8b-7af0-4701-a879-4d16e1e5d768';
...
Would you like specific guidance for your industry?', NOW() - INTERVAL '10 days' + INTERVAL '3 minutes', '{}');
  ...
  RAISE NOTICE 'Mock data inserted successfully for user: c887ef8b-7af0-4701-a879-4d16e1e5d768';
END $$;
